...
// Roadmap
Route::get('/projects/{project}/roadmap', [RoadmapController::class, 'show'])->middleware('auth')->name('projects.roadmap');
...
// Kanban
Route::get('/projects/{project}/kanban/{sprint?}', [ProjectController::class, 'kanban'])->name('projects.kanban');
Route::post('/projects/{project}/kanban/{sprint}/tasks', [ProjectController::class, 'storeKanbanTask'])->name('kanban.tasks.store');
...
// Membres : supprimer / modifier rôle
Route::delete('/projects/{project}/remove-member/{user}', [ProjectController::class, 'removeMember'])->name('projects.removeMember');
Route::put('/projects/{project}/members/{user}/update-role', [ProjectController::class, 'updateMemberRole'])->name('projects.updateMemberRole');
